# ☕️ Aprendizaje de Java

Bienvenidos a mi repositorio de aprendizaje en Java, donde estaré subiendo
ejercicios, apuntes, ejemplos y otros recursos sobre conceptos clave de Java.
Este repositorio está pensado para ayudar a cualquiera que necesite repasar
algún concepto, así como para documentar mi propio progreso paso a paso en este
lenguaje.
...
1. [Declaración de Variables y Tipos de Datos](variables_tipo_datos)
   ...
   - 💡 Ejemplos prácticos sobre cómo funcionan las variables en Java
